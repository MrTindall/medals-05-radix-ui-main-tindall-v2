...
function App() {
  ...
  const apiEndpoint = "https://medals-amt-25.azurewebsites.net/jwtapi/country";
  const hubEndpoint = "https://medals-amt-25.azurewebsites.net/medalsHub";
  const userEndpoint = "https://medals-amt-17-auth.azurewebsites.net/api/user/login";
